...
@Log4j2
        //@Service
class DiscountsOn3DPlasticMonofilamentServiceLegacy extends DiscountsOn3DPlasticV2Service {
    ...
    @Autowired
    public DiscountsOn3DPlasticMonofilamentServiceLegacy(@Value("${parser.mono.urls}") String urls,
                                                         @Value("${parser.mono.time-to-wait-till-parse-new-url}") long waitTime,
                                                         @Qualifier("htmlPageMonoParserLegacy") HtmlPageParserLegacy parser) {
