...
@Log4j2
@Service
public class DiscountsOn3DPlastic3DUAService extends DiscountsOn3DPlasticService {
    ...
    @Autowired
    public DiscountsOn3DPlastic3DUAService(@Value("${parser.3dua.settings}") String settings,
